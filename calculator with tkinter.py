...
addition = Button(frame, text="+", height=4, width=9, font=35, fg= "orange", command=lambda: button_press("+"))
addition.grid(row=0, column=3)

substraction = Button(frame, text="-", height=4, width=9, font=35,  fg= "orange", command=lambda: button_press("-"))
substraction.grid(row=1, column=3)

multiplication = Button(frame, text="x", height=4, width=9, font=35,  fg= "orange", command=lambda: button_press("*"))
multiplication.grid(row=2, column=3)

division = Button(frame, text="/", height=4, width=9, font=35,  fg= "orange", command=lambda: button_press("/"))
division.grid(row=3, column=3)

equal = Button(frame, text="=", height=4, width=9, font=35,  fg= "orange", command=equals)
equal.grid(row=3, column=2)

decimal = Button(frame, text=".", height=4, width=9, font=35, command=lambda: button_press("."))
decimal.grid(row=3, column=1)

clear_button = Button(root, text="clear", height=4, width=12, font=35,  bg= "orange",fg="white",  command=clear)
clear_button.pack()
